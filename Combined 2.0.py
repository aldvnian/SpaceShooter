...
class Player(Spaceship):
    ...
    def loadBullet(self):
        newBullet = Bullet("https://aldvnian.github.io/Spaceshooter-sprites/craftpix-991101-free-pixel-art-enemy-spaceship-2d-sprites/PNG_Parts&Spriter_Animation/Shots/Shot6/shot6_3.png",
                                    (self.pos.x, self.pos.y - 45),
                                    (100, 80),
                                    -math.pi/2
        )
        self.shots.append(newBullet)
